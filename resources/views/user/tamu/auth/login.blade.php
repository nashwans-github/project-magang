...
<div class="flex items-center justify-center min-h-screen px-4 py-20 relative">
    ...
    <a href="/" class="absolute top-5 left-5 z-[9999]">
    ...
    <div class="bg-black/90 backdrop-blur-xl w-full max-w-[620px] rounded-3xl p-10 border border-white/10 shadow-[0_0_60px_#FBCD35FF,_0_0_250px_#FBCD3540,_0_0_400px_#FBCD3520]">
        ...
        {{-- TITLE --}}
        <h2 class="text-[42px] text-[#0554F2] font-poppins font-[799] ">Masuk</h2>
        <div class="mb-1">
        </div>
        ...
        <form action="{{ route('login.authenticate') }}" method="POST" class="space-y-4">
            ...
            <div class="flex justify-end -mt-2">
                <a href="/lupa-password" class="text-[#0554F2] text-[15px] font-poppins font-[600] hover:underline">
                    Lupa password?
                </a>
            </div>

            <button type="submit"
                class="w-full mt-1 px-4 py-3 rounded-[13px] bg-[#0554F2] text-[#FFFFFF] py-3 text-[23px] font-poppins font-[600]">
                Masuk
            </button>

            {{-- Tidak punya akun? Mendaftar --}}
            <div class="text-center mt-4">
                <span class="text-white/90 font-poppins text-[15px]">
                    Tidak punya akun?
                </span>
                <a href="/register" class="text-[#0554F2] font-poppins text-[15px] font-[600] hover:underline ml-1">
                    Mendaftar
                </a>
            </div>
        </form>
