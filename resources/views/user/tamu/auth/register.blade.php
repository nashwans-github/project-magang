...
<div class="flex items-center justify-center min-h-screen px-4 py-20 relative">
    ...
    <a href="{{ url()->previous() }}" class="absolute top-5 left-5 z-[9999]">
    ...
    <div class="bg-black/90 backdrop-blur-xl w-full max-w-[620px] rounded-3xl p-10 border border-white/10 shadow-[0_0_60px_#FBCD35FF,_0_0_250px_#FBCD3540,_0_0_400px_#FBCD3520]">
        ...
        <div class="flex items-center gap-3 mb-6 mt-4">
            ...
            <h1 class="text-[16px] text-[#031CFC] font-poppins font-bold uppercase text-[18] tracking-wide">
                Pemerintah Kota Surabaya
            </h1>
        </div>

        {{-- TITLE --}}
        <h2 class="text-[42px] text-[#0554F2] font-poppins font-[799] ">Daftar</h2>
        <div class="mb-1">
        </div>
        <p class="text-[18] font-poppins text-[#FFFFFF] mb-8">Buat akun baru</p>

        {{-- FORM --}}
        <form action="#" method="POST" class="space-y-4">
            <div>
                <label class="text-[#FFFFFF] text-[18] font-poppins">Nama</label>
                <input type="text"
                    class="w-full mt-1 px-4 py-3 rounded-[11px] bg-white/50 font-poppins font-[500] focus:outline-none">
            </div>

            <div>
                <label class="text-[#FFFFFF] text-[18] font-poppins">No. Telp</label>
                <input type="text"
                    class="w-full mt-1 px-4 py-3 rounded-[11px] bg-white/50 font-poppins font-[500] focus:outline-none">
            </div>
            ...
            <div class="relative">
                ...
                {{-- Ikon Mata (Toggle) --}}
                <svg data-password-toggle="passwordInputRegister"
                    ...
                    <path id="eyePathReg1" stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.015 10.015 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.516-2.583" />
                    <path id="eyePathReg2" stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.824 7.522 5 12 5c2.478 0 4.75 1.155 6.31 2.915M3 3l18 18" />
                </svg>
            </div>
